...
function run() {
    try {
        ...
        if (result.status !== 0) {
            ...
            tl.setResult(tl.TaskResult.Succeeded, 'Environment provisioning completed successfully.');
        }
    } catch (err) {
